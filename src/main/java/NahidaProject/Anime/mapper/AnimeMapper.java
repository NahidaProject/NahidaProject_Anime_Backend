...
public interface AnimeMapper {
    ...
    @Update("update anime set a_name=#{a_name},a_release_date=#{a_release_date},a_company=#{a_company},a_set=#{a_set}," +
            "a_type=#{a_type},a_desc=#{a_desc},a_hot=#{a_hot},a_cv=#{a_cv},a_stats=#{a_stats},a_lang=#{a_lang},a_recommend=#{a_recommend} where a_id=#{a_id}")
